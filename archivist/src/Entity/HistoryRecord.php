...
namespace Drupal\archivist\Entity;

use Drupal\Core\Entity\EntityStorageInterface;
use Drupal\Core\Field\BaseFieldDefinition;
use Drupal\Core\Entity\ContentEntityBase;
use Drupal\Core\Entity\EntityTypeInterface;
use Drupal\archivist\HistoryRecordInterface;
use Drupal\user\UserInterface;
use Drupal\Core\Entity\EntityChangedTrait;

/**
 * Defines the History Record entity.
 *
 * @ingroup archivist
 *
 ...
 *       "edit" = "Drupal\archivist\Form\HistoryRecordForm",
 *       "delete" = "Drupal\archivist\Form\HistoryRecordDeleteForm",
 *     },
 *     "access" = "Drupal\archivist\HistoryRecordAccessControlHandler",
 *   },
 ...
 *   },
 *   links = {
 *     "canonical" = "/archivist_history_record/{archivist_history_record}",
 *     "edit-form" = "/archivist_history_record/{archivist_history_record}/edit",
 *     "delete-form" = "/history_record/{archivist_history_record}/delete",
 *     "collection" = "/archivist_history_record/list"
 *   },
 *   field_ui_base_route = "archivist.history_record_settings",
 * )
 *
 ...
 * Example: 'entity.archivist_history_record.canonical'
 *
 * See routing file above for the corresponding implementation
 *
 * The History Record class defines methods and fields for the history record entity.
 *
 * Being derived from the ContentEntityBase class, we can override the methods
 * we want. In our case we want to provide access to the standard fields about
 * creation and changed time stamps.
 * Also the following fields match Ohio History Connections standard fields and are included by default. 
 *
 *
 *
 *
 ...
 *
 *
 * Our interface (see HistoryRecordInterface) also exposes the EntityOwnerInterface.
 ...
 */
class HistoryRecord extends ContentEntityBase implements HistoryRecordInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['id'] = BaseFieldDefinition::create('integer')
      ->setLabel(t('ID'))
      ->setDescription(t('The ID of the History Record entity.'))
      ->setReadOnly(TRUE);

    // Standard field, unique outside of the scope of the current project.
    $fields['uuid'] = BaseFieldDefinition::create('uuid')
      ->setLabel(t('UUID'))
      ->setDescription(t('The UUID of the History Record entity.'))
      ->setReadOnly(TRUE);
    ...
    $fields['name'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Title'))
      ->setDescription(t('The name, label, or displayed title of the History Record.'))
      ->setSettings(array(
        'default_value' => '',
        'max_length' => 255,
        'text_processing' => 0,
    ...
    $fields['subject'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Subject'))
      ->setDescription(t('The category of the history record.'))
      ->setSettings(array(
        'default_value' => '',
        'max_length' => 100,
        'text_processing' => 0,
    ...
    $fields['collection'] = BaseFieldDefinition::create('string')
      ...
      ->setDescription(t('The name of the collection the history record is stored in, if applicable.'))
      ->setSettings(array(
        'default_value' => '',
        'max_length' => 50,
        'text_processing' => 0,
